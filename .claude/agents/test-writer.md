...
You write comprehensive pytest test suites for gmail-archiver. Follow all conventions in
...
def test_my_command_success(runner: CliRunner, mocker: MockerFixture) -> None:
    mock_func = mocker.patch('gmail_archiver.commands.module.some_function')
