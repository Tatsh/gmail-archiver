...
[![GitHub commits since latest release (by SemVer including pre-releases)](https://img.shields.io/github/commits-since/Tatsh/gmail-archiver/v0.1.1/master)](https://github.com/Tatsh/gmail-archiver/compare/v0.1.1...master)
...
[![pre-commit.ci status](https://results.pre-commit.ci/badge/github/Tatsh/gmail-archiver/master.svg)](https://results.pre-commit.ci/latest/github/Tatsh/gmail-archiver/master)
...
```plain
Visit displayed URL to authorize this application. Waiting...
127.0.1.1 - - [17/May/2025 00:50:21] "GET /?code=...&scope=https://mail.google.com/ HTTP/1.1" 200 -
INFO: Logging in.
